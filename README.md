...
Программа `100` раз прогоняет алгоритм расчета множества Мандельброта. 

Число `100` было выбрано, так как тогда погрешность расчёта $< 5%$.
...
В данной реализации используются машинно зависимые векторные инструкции процессора. \
...
Тут будет показана диаграмма, которая построена по данным [финальной таблицы](#финальная-таблица).

![Диаграмма ](/images/diagram.png)

Таблица ускорения производительности относительно простой реализации с уровнем оптимизации = -O0.

|       |   -O0 |   -O1 |   -O2 |   -O3 |
|:-----:|:-----:|:-----:|:-----:|:-----:|
| SIMPLE|   1   |  277% |  303% |  302% |
| VECTOR|  0,39 |  187% |  198% |  590% |
| AVX   |  277% | 1956% | 1956% | 2020% | 

## Анализ результатов

В векторной реализации при флаге -O3 производительность в 2 раза больше, чем при -O2. Произведя анализ их ассемблерного кода с помощью сайта [godbolt.org](https://godbolt.org/), я получил следующие ассемблерные коды: \
...
Из таблиц и графиков видно флаг оптимизации `-O3` ускоряет работу программы в 3 раза. \
...
Данные в таблице имеют размерность такт * $10^5$.
...
|:------:|:---------------:|:---------------:|:---------------:|:---------------:|
| SIMPLE | $12168 \pm 60$  |  $4461 \pm 16$  |  $4104 \pm 24$  |  $4105 \pm 25$  |
| VECTOR | $27756 \pm 218$ |  $6314 \pm 18$  | $5870 \pm 3250$ |  $1936 \pm 11$  |
| AVX    | $4279  \pm 11$  |  $605  \pm 4$   |   $607 \pm 6$   |   $600 \pm 4$   |
...
|:------:|:---------------:|:---------------:|:---------------:|:---------------:|
| SIMPLE | $12168 \pm 60$  |  $4461 \pm 16$  |  $4104 \pm 24$  |  $4105 \pm 25$  |
| VECTOR | $27756 \pm 218$ |  $6314 \pm 18$  | $5870 \pm 3250$ |  $1936 \pm 18$  |
| AVX    | $4279  \pm 11$  |  $605  \pm 4$   |   $607 \pm 6$   |   $600 \pm 4$   |

#### Финальная таблица

Данные в таблице имеют размерность такт * $10^5$. В каждой ячейке находится среднее значение количества тактов и погрешность.

| FINAL  |     -O0     |     -O1     |     -O2     |     -O3     |
|:------:|:-----------:|:-----------:|:-----------:|:-----------:|
| SIMPLE |$1232 \pm 32$| $444 \pm 2$ | $407 \pm 1$ | $411 \pm 6$ |
| VECTOR |$3153 \pm 66$| $653 \pm 10$| $622 \pm 22$| $220 \pm 6$ |
| AVX    | $445 \pm 9$ | $ 62 \pm 1$ | $ 62 \pm 1$ | $61  \pm 1$ |
