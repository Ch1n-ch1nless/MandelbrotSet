...
Число 256 было подобрано таким образом, чтобы самая быстрая реализация отработала за 5 секунд. \ 
Во время каждого прогона выводит количество тактов, затраченных на исполнение данного алгоритма. \
